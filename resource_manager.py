...
class ResourceManager:
    ...
    def update_access_time(self, resource_id: str, resource_type: str = "worktree"):
        """更新资源访问时间"""
        resource_map = {"worktree": self.worktrees, "tmux_session": self.tmux_sessions, "temp_file": self.temp_files}
    ...
    async def cleanup_idle_resources(self) -> Dict:
        ...
        Returns:
            清理统计
        """
        cleanup_stats = {"worktrees_removed": 0, "sessions_killed": 0, "files_cleaned": 0}
    ...
    def get_resource_status(self) -> Dict:
        ...
        return {
            ...
            "temp_files": {"active": len(self.temp_files)},
