...
class TestRequirementExtraction:
    ...
    async def test_complexity_analysis(self):
        ...
        test_cases = [
            ...
            ({"description": "修复登录按钮样式", "context": "UI调整", "tags": ["ui", "fix"]}, "low"),
            ({"description": "添加用户导出功能", "context": "中等复杂度", "tags": ["feature"]}, "medium"),
        ]
    ...
    async def test_agent_selection(self):
        ...
        test_cases = [("high", "glm5-plus"), ("medium", "glm5-turbo"), ("low", "glm5-lite")]
