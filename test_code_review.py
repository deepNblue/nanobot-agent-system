...
'''
    ...
    async def test_score_calculation(self):
        ...
        for case in test_cases:
            score = self.reviewer.calculate_score(
                ...
                {"score": case["static_score"]},
                {"score": case["test_score"]}
            )
    ...
    async def test_comment_generation(self):
        ...
        llm_review = {
            ...
            "details": {
                "security": [
                    {"severity": "high", "message": "硬编码密码", "line": 10}
                ],
                "performance": [
                    {"severity": "medium", "message": "循环中字符串拼接", "line": 20}
                ]
            },
        ...
        static_review = {
            "score": 80,
            "details": [
                {"tool": "flake8", "error_count": 3, "errors": ["E501 line too long"]}
            ]
        }
...
class TestCICDIntegration:
    ...
    async def test_retry_logic(self):
        ...
        test_cases = [
            {
                "analysis": {"error_type": "network", "confidence": 0.8},
                "should_retry": True,
                "reason": "网络问题应该重试"
            },
            {
            ...
            {
                "analysis": {"error_type": "build", "confidence": 0.9},
                "should_retry": False,
                "reason": "构建问题不应重试"
            },
            {
                "analysis": {"error_type": "test", "confidence": 0.6},
                "should_retry": False,
                "reason": "测试失败不应重试"
            },
            {
                "analysis": {"error_type": "network", "confidence": 0.3},
                "should_retry": False,
                "reason": "置信度太低不应重试"
            }
        ]
        ...
        for case in test_cases:
            ...
            assert should_retry == case["should_retry"], \
                f"重试判断错误: {case['reason']}"
...
class TestIntegration:
    ...
    async def test_full_workflow_simulation(self):
        ...
        review_result = {
            ...
            "layers": {
                "llm_review": {"score": 88},
                "static_review": {"score": 82},
                "test_review": {"score": 85}
            },
            "summary": "代码质量良好，建议通过"
        }
