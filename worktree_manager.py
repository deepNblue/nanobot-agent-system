...
class WorktreeManager:
    ...
    def create_worktree(
        ...
        if worktree_path.exists():
            return {
                "success": False,
                "error": f"Worktree已存在: {worktree_path}",
    ...
    def remove_worktree(self, task_id: str, force: bool = False) -> Dict:
        ...
        if not worktree_path.exists():
            return {
                "success": False,
                "error": f"Worktree不存在: {worktree_path}"
            }
        ...
        try:
            ...
            return {
                "success": True,
                "message": f"Worktree已移除: {worktree_path}"
            }
            
        except Exception as e:
            return {
                "success": False,
                "error": f"移除worktree异常: {str(e)}"
            }
